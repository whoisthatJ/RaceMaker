...
namespace GameAnalyticsSDK.Editor
{
    ...
    public class GA_SettingsInspector : UnityEditor.Editor
    {
        ...
        private static IEnumerator<WWW> SignupUserFrontend(WWW www, GameAnalyticsSDK.Setup.Settings ga, GA_SignUp signup)
        {
            yield return www;
        ...
        private static IEnumerator<WWW> LoginUserFrontend(WWW www, GameAnalyticsSDK.Setup.Settings ga)
        {
            yield return www;
        ...
        private static IEnumerator<WWW> GetUserDataFrontend(WWW www, GameAnalyticsSDK.Setup.Settings ga)
        {
            yield return www;
        ...
        public static void CreateGame(GameAnalyticsSDK.Setup.Settings ga, GA_SignUp signup, int studioIndex, string gameTitle, string googlePlayPublicKey, RuntimePlatform platform, AppFiguresGame appFiguresGame)
        {
            Hashtable jsonTable = new Hashtable();
        ...
        private static IEnumerator<WWW> CreateGameFrontend(WWW www, GameAnalyticsSDK.Setup.Settings ga, GA_SignUp signup, RuntimePlatform platform, AppFiguresGame appFiguresGame)
        {
            yield return www;
        ...
        private static IEnumerator<WWW> GetAppFiguresFrontend(WWW www, GameAnalyticsSDK.Setup.Settings ga, GA_SignUp signup, string gameName)
        {
            yield return www;

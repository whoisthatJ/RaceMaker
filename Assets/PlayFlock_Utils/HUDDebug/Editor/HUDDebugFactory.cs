        ...
        void Update()
        {
            if (EditorPrefs.GetBool("isCreatingNode"))
            {
                if (!EditorApplication.isCompiling)
                {
                    ...
                    UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent( go, "Assets/PlayFlock_Utils/HUDDebug/Editor/HUDDebugFactory.cs (129,21)", componentName );
#endif
            ...
            if (EditorPrefs.GetBool("isCreatingWidget"))
            {
                if (!EditorApplication.isCompiling)
                {
                    ...
                    UnityEngineInternal.APIUpdaterRuntimeServices.AddComponent(go, "Assets/PlayFlock_Utils/HUDDebug/Editor/HUDDebugFactory.cs (164,21)", componentName);
#endif

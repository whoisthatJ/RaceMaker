...
namespace Playflock.Log
{
    ...
    public class HUDDelegate : MonoBehaviour
    {
        ...
        private const int nodesLimit = 10;
        //limit nodes per page
        private int lastNodeIndex = 0;
        //by default 0 is home nodes
        ...
        void Awake()
        {
            ...
            if (instance == null)
            {
                ...
                //Hidden Open Btn
                //preferences.openBtn.GetComponent<Image>().color = new Color(f, 0f, 0f, 0f);
                previousNodeID = 0;
                ...
                if (rootNodes.Count > 0 && rootNodes != null)
        ...
        void OnDestroy()
        {
            if (this.gameObject != null && preferences.openBtn != null && hudRootAction != null)
            {
        ...
        public void ShowHUDRoot(string title, List<RootNode> _rootNodes)
        {
            ...
            rootNode.Find("Text").GetComponent<Text>().text = title;
            ...
            var prefab = Instantiate(prefabNode);
                ...
                {
                    prefab.Find("Icon").GetComponent<Image>().sprite = _rootNodes[i].node.icon;
                }
                else
                {
                    prefab.Find("Icon").GetComponent<Image>().enabled = false;
                    prefab.Find("Title").GetComponent<Text>().text = _rootNodes[i].node.title;
                }
